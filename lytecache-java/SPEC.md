# LyteCache Storage Specification

This document defines the storage schema and type encoding for LyteCache. It is the canonical reference for cross-language implementations.
