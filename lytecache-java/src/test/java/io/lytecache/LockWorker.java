 ...
 * lock (so the append itself is atomic even though {@code logFile} is outside LyteCache), sleeps
 * {@code holdMillis} while holding the LyteCache lock, appends "END", then releases.
 */
public final class LockWorker {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (LyteCache cache = LyteCache.builder().path(dbPath).sweepInterval(null).build()) {
